using ConsoleApp22.AppDbContext;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        InsertProduct(new Product { Name = "New Product", Price = 50, CategoryId = 1 }, context);
        GetAllProducts(context);
        ...
        UpdateProduct(2, new Product { Name = "New Product", Price = 80, CategoryId = 1 }, context);
        GetAllProducts(context);
    }
